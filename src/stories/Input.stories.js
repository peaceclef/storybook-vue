import Input from '@/components/vue3_v0.1/core/Input.vue'

export default {
    title: 'core_v0.1(vue3)/Input',
    component: Input,
    tags: ['autodocs'],
    argTypes: {
        size: {
          description: 'Input 크기를 설정합니다.',
          table: {
