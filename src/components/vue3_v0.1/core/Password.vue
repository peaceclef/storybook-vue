<template>
    <div :class="pwdDivContainerClass">
        <input type="password" :class="pwdInputPasswordClass" :value="value" @input="inputPwd"/>
    </div>
</template>
...
export default {
    ...
    setup(props){
        ...
        return {
            pwdDivContainerClass: computed(() => ({
                'pwd-div-container': true,
            ...
            pwdInputPasswordClass: computed(() => ({
                'pwd-input-password': true,
                'size-extra-small': props.size === 'xs',
                'size-small': props.size === 'sm',
                'size-medium': props.size === 'md' || props.size == undefined,
                'size-large': props.size === 'lg',
